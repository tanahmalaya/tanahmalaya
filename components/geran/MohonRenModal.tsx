  ...
  if (statusInfo) {
    return (
      <div className="flex items-center gap-2 bg-white border border-black/5 rounded-xl px-3.5 py-2.5">
        <span className="text-xs font-semibold text-[#0E3B2E]/70">PLT-Registered REN:</span>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-md max-h-[90vh] overflow-y-auto p-6">
            ...
            <p className="text-[#0E3B2E]/60 text-sm mb-5">
              A PLT-registered REN can list land directly (without waiting for admin review). Fill in your
              details &amp; REN registration number below.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className={GERAN_LABEL}>REN Registration No.</label>
                <input
                  required
                  value={noRen}
              ...
              <label className="flex items-start gap-3 bg-[#F7F5F1] rounded-xl p-3.5 cursor-pointer">
                ...
                <span className="text-sm text-[#0E3B2E]/80">
                  I confirm this REN registration number is valid &amp; registered with LPPEH. False
              ...
              <div className="flex items-start gap-2 bg-blue-50 border border-blue-200 rounded-xl p-3 text-xs text-blue-700">
                <span>ℹ️</span>
                <span>
                  <span className="font-semibold">What happens next?</span> PLT admin will verify your REN
                  registration number. Once approved, your land listings will be approved automatically.
                </span>
              </div>
