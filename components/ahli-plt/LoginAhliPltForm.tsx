...
import { IconUserCircle, IconSearch } from "@/components/keahlian/icons";
      ...
      <div className="max-w-lg mx-auto px-6 pb-16">
        <div className={CARD}>
          ...
          <p className="text-brand-dark/60 text-sm mb-5">
            Sama seperti Semak Keahlian - masukkan nama penuh dan No. Kad Pengenalan seperti didaftarkan.
          </p>
